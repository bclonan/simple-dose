...
<template>
  <article class="prescription-card" data-testid="prescription-request-card">
    <header class="prescription-card__header">
      ...
      <div>
        <p class="eyebrow">Prescription request</p>
    ...
    <dl class="prescription-grid">
      ...
      <div class="wide"><dt>Estimated patient price</dt><dd class="prescription-card__price">{{ formatCurrency(request.estimatedTotal) }} delivered</dd></div>
    ...
    <section class="pharmacy-destination">
      <p class="eyebrow">Send the prescription to</p>
